...
if "%~1"=="" (
  echo Usage: upgrade-from-v0.3.4.bat "C:\path\to\protean-workspace-v0.3.4"
  echo.
...
if exist "%~dp0instance" (
  echo ERROR: This v0.4.0 folder already has an instance folder.
...
echo Start Protean Workspace v0.4.0 normally.
pause
