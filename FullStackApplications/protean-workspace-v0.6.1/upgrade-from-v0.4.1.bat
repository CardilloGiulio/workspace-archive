...
if "%~1"=="" (
  echo Usage: upgrade-from-v0.4.1.bat "C:\path\to\protean-workspace-v0.4.1"
  echo.
...
if exist "%~dp0instance" (
  echo ERROR: This v0.4.2 folder already has an instance folder.
...
echo Start Protean Workspace v0.4.2 normally.
pause
