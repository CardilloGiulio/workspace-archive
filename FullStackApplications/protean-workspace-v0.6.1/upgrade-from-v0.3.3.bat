...
if "%~1"=="" (
  echo Usage: upgrade-from-v0.3.3.bat "C:\path\to\protean-workspace-v0.3.3"
  echo.
...
if exist "%~dp0instance" (
  echo ERROR: This v0.3.4 folder already has an instance folder.
...
echo Start Protean Workspace v0.3.4 normally.
pause
